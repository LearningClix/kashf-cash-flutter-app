...
class Scene extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Container(
        // subprcommunityrulesnv8 (144:3227)
        width: double.infinity,
        ...
        child: Column(
          ...
          children: [
            Container(
              // topbarcontenttitlevmS (188:3925)
              ...
              child: Column(
                ...
                children: [
                  Container(
                    // statusbariphone35N (I188:3925;188:3891)
                    ...
                    child: Row(
                      ...
                      children: [
                        Container(
                          // timeMrk (I188:3925;188:3891;6:3979)
                        ...
                        Container(
                          // levelsGyi (I188:3925;188:3891;6:3980)
                          ...
                          child: Row(
                            ...
                            children: [
                              Container(
                                // cellularconnectionC6g (I188:3925;188:3891;6:3986)
                                margin: EdgeInsets.fromLTRB(0*fem, 0.3*fem, 7.5*fem, 0*fem),
                                width: 19.2*fem,
                                height: 12.23*fem,
                                child: Image.asset(
                                  'assets/ui-prototype/images/cellular-connection-ufi.png',
                                  width: 19.2*fem,
                                  height: 12.23*fem,
                                ),
                              ),
                              Container(
                                // wifihp8 (I188:3925;188:3891;6:3985)
                                margin: EdgeInsets.fromLTRB(0*fem, 0.6*fem, 7.16*fem, 0*fem),
                                width: 17.14*fem,
                                height: 12.33*fem,
                                child: Image.asset(
                                  'assets/ui-prototype/images/wifi-JrG.png',
                                  width: 17.14*fem,
                                  height: 12.33*fem,
                                ),
                              ),
                              Container(
                                // batteryptk (I188:3925;188:3891;6:3981)
                                width: 27.33*fem,
                                height: 13*fem,
                                child: Image.asset(
                                  'assets/ui-prototype/images/battery-j16.png',
                                  width: 27.33*fem,
                                  height: 13*fem,
                                ),
                              ),
                  ...
                  Container(
                    // frame37038Z5e (I188:3925;188:3892)
                    ...
                    child: Row(
                      ...
                      children: [
                        Container(
                          // arrowgAG (I188:3925;188:3893)
                          margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 68.3*fem, 1*fem),
                          width: 19.2*fem,
                          height: 16*fem,
                          child: Image.asset(
                            'assets/ui-prototype/images/arrow-RDN.png',
                            width: 19.2*fem,
                            height: 16*fem,
                          ),
                        ),
                        Container(
                          // privacysettingsPaU (I188:3925;188:3894)
                          margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 68.3*fem, 0*fem),
                          child: Text(
                            'Comunity Rules',
                            style: SafeGoogleFont (
                              'Roboto',
                        ...
                        Container(
                          // arrowHvk (I188:3925;188:3895)
                          margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 0*fem, 1*fem),
                          width: 19.2*fem,
                          height: 16*fem,
                          child: Image.asset(
                            'assets/ui-prototype/images/arrow-Au2.png',
                            width: 19.2*fem,
                            height: 16*fem,
                          ),
                        ),
            ...
            Container(
              ...
              child: Stack(
                children: [
                  Positioned(
                    // loremipsumdolorsitametconsecte (188:2410)
                    left: 0*fem,
                    top: 0*fem,
                    child: Align(
                      child: SizedBox(
                  ...
                  Positioned(
                    // homeindicatorV72 (I272:6536;2:2955)
                    left: 103*fem,
                    top: 710*fem,
                    child: Align(
                      child: SizedBox(
